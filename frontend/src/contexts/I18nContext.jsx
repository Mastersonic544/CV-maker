...
const TRANSLATIONS = {
  en: {
    ...
    nav_discovery: 'Find Jobs',
    nav_review: 'Build CV',
    nav_apply: 'Send Emails',
    ...
    // Setup APIs page
    setup_title: 'Configure your keys.',
    setup_subtitle: 'Add your OpenRouter key to enable AI features. Gmail credentials unlock email applications. All keys are stored encrypted on your machine.',
    setup_phase: 'Phase 02 / API Setup',
    setup_encrypted: 'Encrypted at rest',
    setup_optional_section: 'API Keys',
  ...
  fr: {
    ...
    nav_discovery: 'Trouver des offres',
    nav_review: 'Créer un CV',
    nav_apply: 'Envoyer des emails',
    nav_interview: 'Prép. entretien',
    ...
    setup_subtitle: "Les fonctions IA fonctionnent immédiatement. Ajoutez vos identifiants Gmail pour activer les candidatures par email.",
    setup_phase: 'Phase 02 / Configuration optionnelle',
    setup_encrypted: 'Chiffré au repos',
    setup_optional_section: 'Optionnel — activer les candidatures par email via Gmail',
  ...
  ar: {
    ...
    nav_discovery: 'البحث عن وظائف',
    nav_review: 'بناء السيرة الذاتية',
    nav_apply: 'إرسال البريد',
    nav_interview: 'تحضير المقابلة',
    header_live: 'مباشر',
    ...
    setup_subtitle: 'ميزات الذكاء الاصطناعي تعمل فوراً. أضف بيانات Gmail لتفعيل التقديم بالبريد الإلكتروني.',
    setup_phase: 'المرحلة ٠٢ / إعداد اختياري',
    setup_encrypted: 'مشفّر محلياً',
    setup_optional_section: 'اختياري — تفعيل التقديم بالبريد الإلكتروني عبر Gmail',
